...
def get_data(dataset, source_domain, target_domain, n_class, vocab_size=0):
    ...
    # target_un_y = np.concatenate((np.ones(2000), np.zeros(2000))).reshape(4000, 1)
    ...
    # target_un_y = to_categorical(target_un_y, n_class)
    ...
    print "source_x shape: ", source_x.shape, "test_x shape: ", test_x.shape, \
    "source_un shape: ", source_un.shape, "target_un shape: ",target_un.shape
